...
class H5PSolveStatus extends ActiveRecord {
	 ...
	 * @param int $user_id
	 *
	 * @return H5PSolveStatus|null
	 */
	public static function getByUser($obj_id, $user_id) {
		/**
		 * @var H5PSolveStatus|null $h5p_solve_status
		 */
	 ...
	 * @param int $obj_id
	 *
	 * @return H5PSolveStatus[]
	 */
	public static function getByObject($obj_id) {
		/**
		 * @var H5PSolveStatus[] $h5p_solve_statuses
		 */
	...
	public static function getContentByUser($obj_id, $user_id) {
		...
		$h5p_content = H5PContent::getContentById($h5p_solve_status->getContentId());
