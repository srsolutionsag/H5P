...
/**
 * Class H5PLibraryHubCache
 *
 * @package srag\Plugins\H5P\ActiveRecord
 *
 * @author  studer + raimann ag - Team Custom 1 <support-custom1@studer-raimann.ch>
 */
class H5PLibraryHubCache extends ActiveRecord {
	...
	/**
	 * @return H5PLibraryHubCache[]
	 */
	public static function getLibraries() {
		/**
		 * @var H5PLibraryHubCache[] $h5p_hub_libraries
		 */
	 ...
	 * @param string $name
	 *
	 * @return H5PLibraryHubCache|null
	 */
	public static function getLibraryByName($name) {
		/**
		 * @var H5PLibraryHubCache|null $h5p_hub_library
		 */
	...
	/**
	 * H5PLibraryHubCache constructor
	 *
