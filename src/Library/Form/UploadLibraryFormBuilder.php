 ...
 */
class UploadLibraryFormBuilder extends AbstractFormBuilder
{
    public const INPUT_LIBRARY = 'library';
    ...
    {
        $inputs = [
            self::INPUT_LIBRARY => $this->fields->file(
                $this->upload_handler,
                $this->translator->txt(self::INPUT_LIBRARY),
